<div class="captionUsersInLive" id="online">
    <div class="ui accordion">
        ...
        <div class="title col-xs-12 col-sm-12 col-md-12 col-lg-12 AlluserReegitrados columnChatss captionLikechatsFlotante captionLikechatsFlotanteDta">
            ...
            <div class="captionCircleUser captionDenoews AlluserReegitradosPorBloque" v-for="o in online" v-if="o.id != 'authId'"> <!-- authId varible global del id -->
                <a href="#" @click.prevent="getOrCreate(o.id)" class="userLive" data-idonline="2" data-iduserchat="2" >
