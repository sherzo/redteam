    ...
    <div class="notficiActivitie">
        <div class="ui relaxed divided list">
            <div class="item PublicatiOn">
                ...
                <div class="content">
                    <a data-href='preview-conte/data/viewDme//' href="#!" class="header datanotifiNew"><strong class="nameUserNotifique ">Juan Alberto </strong> Ha realizado una nueva <span class="typeAccionNotifi">
          ...
          publicación</span></a>
            ...
            <div class="item NewFotos">
                ...
                <div class="content">
                    <a  data-href='preview-conte/data/viewDme//' href="#!" class="header datanotifiNew">A 15 personas <span class="typeAccionNotifi ">les gusta tu publicación</span>
                        <input type="hidden" class="notifiview" name='datanotifi' value="">
                        <input type="hidden" class="notifiviewUser" name='datanotifi_iduser' value="">
                    </a>
                </div>
