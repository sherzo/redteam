...
<div class="calendarDatas">
    <div id="carousel-example-generic" class="carousel slide slide1Even" data-ride="carousel" data-interval="false">
        <!-- Wrapper for slides -->
            ...
            <div class="item  active  nameMonth">
                ...
                <div class="daysNumberCalendar">
                    ...
                    <div class="dataDays dayEvento">
                        ...
                        <div class="ui special popup top left transition hidden" style="top: auto; bottom: 153.75px; left: 177.766px; right: auto;">
        ...
        <!-- Controls -->
        <a class="left carousel-control leftCalendarEvent" href=".slide1Even" role="button" data-slide="prev">
            <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="right carousel-control RightCalendarEvent" href=".slide1Even" role="button" data-slide="next">
