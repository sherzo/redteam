                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 bloquesActions actionINEmergency">
                                ...
                                <div class="col-md-6 actionpuBlish">
                                    <div class="col-md-2 Adjuntar adjunEmerImg">
                                        <img class="img-responsive img1DoEmer" onclick="chooseFileDocuEmer()"  src="{{ asset('assets/images/avatar/adjuntarIco.png') }}" alt="">
                                    </div>
                                    <div class="col-md-2 AdjuntarFoto AdjuntarFotoEmergency">
                                        <img class="img-responsive img1FotEmer" onclick="chooseFileIMGEmer()" src="{{ asset('assets/images/avatar/adjuntarFoto.png') }}" alt="">
                                    </div>
